...
async function runTests() {
  ...
  assert.match(taskContent, /^<!-- GENERATED BY project-context init — DO NOT EDIT\. -->\n# TASK-001/m);
  assert(!taskContent.includes('<instructions>'), 'task packet embedded writer instructions');
