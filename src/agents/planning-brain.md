...
After ideation, converge into the structured brief. Do not stream the exploratory reasoning. Do not broadcast your thinking. Do not narrate your reasoning process. Return only the final brief.
